...
update crm_v2.addresses addresses set current_hash = last_hash;
...
update crm_v2.companies companies set current_hash = last_hash;
...
update crm_v2.contacts contacts set current_hash = last_hash;
