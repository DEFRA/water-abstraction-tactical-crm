...
CREATE TABLE IF NOT EXISTS "crm_v2"."roles" (
  "role_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS "crm_v2"."companies" (
  "company_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
  "name" varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS "crm_v2"."contacts" (
  "contact_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
  "salutation" varchar,
  "first_name" varchar,
...
CREATE TABLE IF NOT EXISTS "crm_v2"."company_contacts" (
  "company_contact_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS "crm_v2"."addresses" (
  "address_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS "crm_v2"."company_addresses" (
  "company_address_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
  "company_id" varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS "crm_v2"."phone_numbers" (
  "phone_number_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
  "contact_id" varchar NOT NULL,
  "type" varchar,
...
CREATE TABLE IF NOT EXISTS "crm_v2"."documents" (
  "document_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS "crm_v2"."document_roles" (
  "document_role_id" varchar NOT NULL DEFAULT public.gen_random_uuid(),
